...
import core, {
  ...
  Data,
  disallowDomain,
  Doc, DOMAIN_MODEL, DOMAIN_TX, Emb, generateId, Hierarchy, Ref, Space,
  Storage,
  Tx,
...
describe('mongo operations', () => {
  ...
  async function initDb (): Promise<void> {
    ...
    const clientStorage = combine(
      allowDomain(hierarchy, txStorage, DOMAIN_TX), // Allow only Tx
      disallowDomain(hierarchy, docStorage, DOMAIN_MODEL)
    )
