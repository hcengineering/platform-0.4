...
<svg width={size} height={size} {fill} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M8,0C3.6,0,0,3.6,0,8c0,1.5,0.4,2.8,1.1,4L0,16l4.1-0.9C5.3,15.6,6.7,16,8,16c4.4,0,8-3.6,8-8S12.4,0,8,0z M8,14.8c-1.5,0-2.8-0.4-3.9-1.2l-2.3,0.5l0.7-2.3C1.7,10.8,1.2,9.5,1.2,8c0-3.7,3.1-6.8,6.8-6.8s6.8,3.1,6.8,6.8S11.7,14.8,8,14.8z"/>
</svg>
