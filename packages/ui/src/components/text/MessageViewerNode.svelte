<script lang="ts">
  ...
  let hrefVal: Pick<Doc, '_id' | '_class'> = { _class: '' as Ref<Class<Doc>>, _id: '' as Ref<Doc> }
  ...
  $: hrefVal = { _class: style.reference._class as Ref<Class<Doc>>, _id: style.reference._id as Ref<Doc> }
